 ...
 */
const operation = require('../../lib/operations/daemuri')

describe('/daemuri', function () {
  it('정확한 이름으로 호출해야 됩니당. 다시 확인해주세용.', () => expect(operation.name).toEqual('야, 대머리'))

  it('정확한 URL 로 호출해야 됩니당. 다시 확인해주세용.', () => expect(operation.url).toEqual('/daemuri/:from'))
  ...
  return describe('register', function () {
    it('정확한 URL 로 app.get 을 호출해야 됩니당.', function () {
      ...
      expect(app.get).toHaveBeenCalledWith('/daemuri/:from', jasmine.any(Function))
    })
